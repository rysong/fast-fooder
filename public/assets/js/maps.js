    ...
    function placeMarkers(markers) {
          ...
          if (markers[i]["marker_color"]) {
            ...
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper::before { background-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper .pin { border-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper .pin::before { background-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper .pin::before { border-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper .pin .image::after { border-color: ' +
                color +
            ...
            document.styleSheets[0].insertRule(
              '.map .marker[data-color="' +
                color +
                '"] .marker-wrapper .tag { background-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.hero-section .results-wrapper .result-item[data-id="' +
                markers[i]["id"] +
                '"] > a::before { background-color: ' +
                color +
                "}",
              0
            );
            document.styleSheets[0].insertRule(
              '.sidebar-content[data-id="' +
                markers[i]["id"] +
            ...
            (function(marker, i) {
              return function() {
                if (markerTarget == "sidebar") {
                  ...
                  openInfobox(
                    $(this.content.firstChild).attr("data-id"),
                    this,
                    i
                  );
      ...
      $(".marker")
        .live("mouseenter", function() {
          ...
          $(
            ".results-wrapper .results-content .result-item[data-id=" +
              id +
              "] a"
      ...
      google.maps.event.addListener(markerCluster, "click", function(e) {
        ...
        for (i = 0; i < e.markers_.length; i++) {
          markerClusterArray.push(
            $(e.markers_[i].content.innerHTML).attr("data-id")
          );
        ...
        if (
          checkIfSame(e.markers_[0].position.lat(), markerPositionLatitude) ===
          true
        ) {
          if (
            checkIfSame(
              e.markers_[0].position.lng(),
      ...
      function renderResults() {
        ...
        for (var i = 0; i < newMarkers.length; i++) {
          if (map.getBounds().contains(newMarkers[i].getPosition())) {
            ...
            visibleMarkersId.push(
              $(newMarkers[i].content.firstChild).attr("data-id")
            );
        ...
        $.ajax({
          ...
          success: function(results) {
            ...
            $(".result-item, .results-content .item")
              .children("a")
              .on("click", function(e) {
